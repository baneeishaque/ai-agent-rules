...
[View Source File](file:///Users/dk/lab-data/ai-agents/ai-agent-rules/architectures/sync/types.ts)
...
- **SyncConfig (Interface)**:
    - **Purpose**: Typed structure for [config.json](file:///Users/dk/lab-data/ai-agents/ai-agent-rules/architectures/sync/config.json). Ensures relay lists and salts are accessed safely by the worker without hardcoding ([Config Explainer](file:///Users/dk/lab-data/ai-agents/ai-agent-rules/architectures/sync/config.json.md)).
