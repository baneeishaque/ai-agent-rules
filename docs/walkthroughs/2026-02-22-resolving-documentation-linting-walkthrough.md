...
- **[README.md](../../README.md)** now features a dedicated `Agent Skills` section.
- **[agent-rules.md](../../agent-rules.md)** provides a flat index of both Skills and Rules.
...
Executed from the project root (`/Users/dk/lab-data/ai-agents/`):
