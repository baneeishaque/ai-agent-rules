...
| Git Submodule History Repair Rules | [git-submodule-history-repair-rules.md](./git-submodule-history-repair-rules.md) | Protocols for repairing broken submodule pointers caused by history rewrites in submodule repositories. |
...
| Homebrew Management Rules | [brew-rules.md](./brew-rules.md) | Comprehensive SSOT for Homebrew operations, including installation preferences, keg-only handling, and exclusion-based upgrade workflows. |
...
| LinkedIn Contributor Call Rules | [linkedin-contributor-call-rules.md](./linkedin-contributor-call-rules.md) | Specialized protocol for drafting "Call for Contributors" posts to recruit developers for personal projects, focusing on mentorship, labour-rich stacks, and leadership. |
...
| Script Management Rules | [script-management-rules.md](./script-management-rules.md) | Script standards, folder usage, and safeguards for helper scripts. |
