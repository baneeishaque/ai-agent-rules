<!--
title: GitHub Pull Request Processing
...
-   **Documentation**: Ensure all PR-related edits (e.g., to README) follow the [GitHub-Repository-Metadata-Management-rules.md](./GitHub-Repository-Metadata-Management-rules.md).
