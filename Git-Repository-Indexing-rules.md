<!--
title: Git Repo Indexing
description: Rules for auto-indexing codebases within git repositories for improved agent context.
category: Git & Repository Management
-->

# Git Repository: Auto-index Codebases
